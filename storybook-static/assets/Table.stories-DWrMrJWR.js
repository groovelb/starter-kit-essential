...
| Selectable | 선택 가능 | \`Checkbox\` 포함 |
        `}}},argTypes:{size:{control:"select",options:["small","medium"],description:"테이블 셀의 크기를 설정합니다.",table:{type:{summary:"string"},defaultValue:{summary:"medium"}}},stickyHeader:{control:"boolean",description:"테이블 헤더를 고정합니다.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},padding:{control:"select",options:["normal","checkbox","none"],description:"셀 패딩을 설정합니다.",table:{type:{summary:"string"},defaultValue:{summary:"normal"}}}}},V=(l,a,o,d,g,r)=>({id:l,name:a,calories:o,fat:d,carbs:g,protein:r}),x=[V(1,"프로즌 요거트",159,6,24,4),V(2,"아이스크림 샌드위치",237,9,37,4.3),V(3,"에클레어",262,16,24,6),V(4,"컵케이크",305,3.7,67,4.3),V(5,"진저브레드",356,16,49,3.9)],pl=[{id:1,name:"김철수",email:"kim@example.com",role:"관리자",status:"활성"},{id:2,name:"이영희",email:"lee@example.com",role:"편집자",status:"활성"},{id:3,name:"박민수",email:"park@example.com",role:"뷰어",status:"비활성"},{id:4,name:"최수진",email:"choi@example.com",role:"편집자",status:"활성"},{id:5,name:"정대현",email:"jung@example.com",role:"뷰어",status:"대기"}],G={args:{size:"medium",stickyHeader:!1,padding:"normal"},render:l=>e.jsx(k,{component:M,sx:{maxHeight:l.stickyHeader?300:"none"},children:e.jsxs(I,{size:l.size,stickyHeader:l.stickyHeader,padding:l.padding,children:[e.jsx(H,{children:e.jsxs(p,{children:[e.jsx(t,{children:"디저트 (100g)"}),e.jsx(t,{align:"right",children:"칼로리"}),e.jsx(t,{align:"right",children:"지방 (g)"}),e.jsx(t,{align:"right",children:"탄수화물 (g)"}),e.jsx(t,{align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.map(a=>e.jsxs(p,{children:[e.jsx(t,{component:"th",scope:"row",children:a.name}),e.jsx(t,{align:"right",children:a.calories}),e.jsx(t,{align:"right",children:a.fat}),e.jsx(t,{align:"right",children:a.carbs}),e.jsx(t,{align:"right",children:a.protein})]},a.id))})]})})},O={render:()=>e.jsx(k,{component:M,children:e.jsxs(I,{size:"small",children:[e.jsx(H,{children:e.jsxs(p,{children:[e.jsx(t,{children:"디저트 (100g)"}),e.jsx(t,{align:"right",children:"칼로리"}),e.jsx(t,{align:"right",children:"지방 (g)"}),e.jsx(t,{align:"right",children:"탄수화물 (g)"}),e.jsx(t,{align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.map(l=>e.jsxs(p,{children:[e.jsx(t,{component:"th",scope:"row",children:l.name}),e.jsx(t,{align:"right",children:l.calories}),e.jsx(t,{align:"right",children:l.fat}),e.jsx(t,{align:"right",children:l.carbs}),e.jsx(t,{align:"right",children:l.protein})]},l.id))})]})})},E={render:()=>e.jsx(k,{component:M,children:e.jsxs(I,{children:[e.jsx(H,{children:e.jsxs(p,{sx:{backgroundColor:"primary.main"},children:[e.jsx(t,{sx:{color:"white",fontWeight:700},children:"디저트 (100g)"}),e.jsx(t,{sx:{color:"white",fontWeight:700},align:"right",children:"칼로리"}),e.jsx(t,{sx:{color:"white",fontWeight:700},align:"right",children:"지방 (g)"}),e.jsx(t,{sx:{color:"white",fontWeight:700},align:"right",children:"탄수화물 (g)"}),e.jsx(t,{sx:{color:"white",fontWeight:700},align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.map((l,a)=>e.jsxs(p,{sx:{backgroundColor:a%2===0?"grey.50":"white"},children:[e.jsx(t,{component:"th",scope:"row",children:l.name}),e.jsx(t,{align:"right",children:l.calories}),e.jsx(t,{align:"right",children:l.fat}),e.jsx(t,{align:"right",children:l.carbs}),e.jsx(t,{align:"right",children:l.protein})]},l.id))})]})})},_={render:()=>{const[l,a]=S.useState([]),o=r=>{r.target.checked?a(x.map(s=>s.id)):a([])},d=r=>{const s=l.indexOf(r);let n=[];s===-1?n=[...l,r]:n=l.filter(i=>i!==r),a(n)},g=r=>l.indexOf(r)!==-1;return e.jsxs(k,{component:M,children:[e.jsxs(I,{children:[e.jsx(H,{children:e.jsxs(p,{children:[e.jsx(t,{padding:"checkbox",children:e.jsx(ye,{indeterminate:l.length>0&&l.length<x.length,checked:x.length>0&&l.length===x.length,onChange:o})}),e.jsx(t,{children:"디저트 (100g)"}),e.jsx(t,{align:"right",children:"칼로리"}),e.jsx(t,{align:"right",children:"지방 (g)"}),e.jsx(t,{align:"right",children:"탄수화물 (g)"}),e.jsx(t,{align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.map(r=>{const s=g(r.id);return e.jsxs(p,{hover:!0,onClick:()=>d(r.id),selected:s,sx:{cursor:"pointer"},children:[e.jsx(t,{padding:"checkbox",children:e.jsx(ye,{checked:s})}),e.jsx(t,{component:"th",scope:"row",children:r.name}),e.jsx(t,{align:"right",children:r.calories}),e.jsx(t,{align:"right",children:r.fat}),e.jsx(t,{align:"right",children:r.carbs}),e.jsx(t,{align:"right",children:r.protein})]},r.id)})})]}),e.jsx(He,{sx:{p:2,borderTop:1,borderColor:"divider"},children:e.jsxs(fe,{variant:"body2",color:"text.secondary",children:[l.length,"개 선택됨"]})})]})}},K={render:()=>{const[l,a]=S.useState("asc"),[o,d]=S.useState("calories"),g=n=>{a(o===n&&l==="asc"?"desc":"asc"),d(n)},r=[...x].sort((n,i)=>l==="asc"?n[o]<i[o]?-1:1:n[o]>i[o]?-1:1),s=[{id:"name",label:"디저트 (100g)",align:"left"},{id:"calories",label:"칼로리",align:"right"},{id:"fat",label:"지방 (g)",align:"right"},{id:"carbs",label:"탄수화물 (g)",align:"right"},{id:"protein",label:"단백질 (g)",align:"right"}];return e.jsx(k,{component:M,children:e.jsxs(I,{children:[e.jsx(H,{children:e.jsx(p,{children:s.map(n=>e.jsx(t,{align:n.align,sortDirection:o===n.id?l:!1,children:e.jsx(hl,{active:o===n.id,direction:o===n.id?l:"asc",onClick:()=>g(n.id),children:n.label})},n.id))})}),e.jsx(L,{children:r.map(n=>e.jsxs(p,{hover:!0,children:[e.jsx(t,{component:"th",scope:"row",children:n.name}),e.jsx(t,{align:"right",children:n.calories}),e.jsx(t,{align:"right",children:n.fat}),e.jsx(t,{align:"right",children:n.carbs}),e.jsx(t,{align:"right",children:n.protein})]},n.id))})]})})}},q={render:()=>{const[l,a]=S.useState(0),[o,d]=S.useState(2),g=(s,n)=>{a(n)},r=s=>{d(parseInt(s.target.value,10)),a(0)};return e.jsxs(M,{children:[e.jsx(k,{children:e.jsxs(I,{children:[e.jsx(H,{children:e.jsxs(p,{children:[e.jsx(t,{children:"디저트 (100g)"}),e.jsx(t,{align:"right",children:"칼로리"}),e.jsx(t,{align:"right",children:"지방 (g)"}),e.jsx(t,{align:"right",children:"탄수화물 (g)"}),e.jsx(t,{align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.slice(l*o,l*o+o).map(s=>e.jsxs(p,{children:[e.jsx(t,{component:"th",scope:"row",children:s.name}),e.jsx(t,{align:"right",children:s.calories}),e.jsx(t,{align:"right",children:s.fat}),e.jsx(t,{align:"right",children:s.carbs}),e.jsx(t,{align:"right",children:s.protein})]},s.id))})]})}),e.jsx(sl,{rowsPerPageOptions:[2,3,5],component:"div",count:x.length,rowsPerPage:o,page:l,onPageChange:g,onRowsPerPageChange:r,labelRowsPerPage:"페이지당 행:"})]})}},J={render:()=>{const l=o=>{switch(o){case"활성":return"success";case"비활성":return"error";case"대기":return"warning";default:return"default"}},a=o=>{switch(o){case"관리자":return"filled";default:return"outlined"}};return e.jsx(k,{component:M,children:e.jsxs(I,{children:[e.jsx(H,{children:e.jsxs(p,{sx:{backgroundColor:"grey.100"},children:[e.jsx(t,{sx:{fontWeight:700},children:"이름"}),e.jsx(t,{sx:{fontWeight:700},children:"이메일"}),e.jsx(t,{sx:{fontWeight:700},children:"역할"}),e.jsx(t,{sx:{fontWeight:700},children:"상태"})]})}),e.jsx(L,{children:pl.map(o=>e.jsxs(p,{hover:!0,children:[e.jsx(t,{children:e.jsx(fe,{variant:"body2",sx:{fontWeight:500},children:o.name})}),e.jsx(t,{children:e.jsx(fe,{variant:"body2",color:"text.secondary",children:o.email})}),e.jsx(t,{children:e.jsx(Se,{label:o.role,size:"small",variant:a(o.role),color:o.role==="관리자"?"primary":"default"})}),e.jsx(t,{children:e.jsx(Se,{label:o.status,size:"small",color:l(o.status)})})]},o.id))})]})})}},Q={render:()=>e.jsx(M,{sx:{width:"100%",overflow:"hidden"},children:e.jsx(k,{sx:{maxHeight:200},children:e.jsxs(I,{stickyHeader:!0,children:[e.jsx(H,{children:e.jsxs(p,{children:[e.jsx(t,{sx:{fontWeight:700},children:"디저트 (100g)"}),e.jsx(t,{sx:{fontWeight:700},align:"right",children:"칼로리"}),e.jsx(t,{sx:{fontWeight:700},align:"right",children:"지방 (g)"}),e.jsx(t,{sx:{fontWeight:700},align:"right",children:"탄수화물 (g)"}),e.jsx(t,{sx:{fontWeight:700},align:"right",children:"단백질 (g)"})]})}),e.jsx(L,{children:x.map(l=>e.jsxs(p,{hover:!0,children:[e.jsx(t,{component:"th",scope:"row",children:l.name}),e.jsx(t,{align:"right",children:l.calories}),e.jsx(t,{align:"right",children:l.fat}),e.jsx(t,{align:"right",children:l.carbs}),e.jsx(t,{align:"right",children:l.protein})]},l.id))})]})})})};G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'medium',
    stickyHeader: false,
    padding: 'normal'
...
}`,...Q.parameters?.docs?.source},description:{story:"고정 헤더 테이블",...Q.parameters?.docs?.description}}};const et=["Default","Dense","Striped","Selectable","Sortable","WithPagination","UserList","StickyHeader"];export{G as Default,O as Dense,_ as Selectable,K as Sortable,Q as StickyHeader,E as Striped,J as UserList,q as WithPagination,et as __namedExportsOrder,Zl as default};
